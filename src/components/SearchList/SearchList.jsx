...
// import { SearchListDiv } from './SearchList.styled';
// import { CarSVG, DateSVG, Favorit, FavoritFilled, LockSVG, PetrolSVG, SlideSVG, SpeedometerSVG } from './SearchListSVG';
// import { selectAdverstisements, selectFavorites } from 'redux/advertisment/selectors'; 
// import { toggleFavorite, getAdverstisementsFavorite } from 'redux/advertisment/operations'; 

// const SearchList = ({ setSort }) => {
//   const cars = useSelector(selectAdverstisements);
...
//       })
//       .catch(error => console.error('Failed to toggle favorite status', error));
//   };
