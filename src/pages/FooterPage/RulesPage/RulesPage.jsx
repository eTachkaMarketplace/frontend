...
const RulesPage = () => {
  return (
    <Container>
      ...
      <Content>
        <SubTitle>Тачка Є працює на ринку вже більше 20 років. І для нас важливо, щоб портал Тачка Є для кожного бажаючого купити або продати автомобіль, спецтехніку або запчастини був надійним та перевіреним ресурсом.
        </SubTitle>
