...
// export const selectAdverstisementsFavorite = state =>state.adverstisement.adverstisementsID;
export const selectAdverstisementsFavorite = state => state.adverstisement.adverstisementsFavorite;

export const selectFavorites = state => state.adverstisement.favorites;
